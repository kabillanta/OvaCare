...
class MindSyncPage extends StatelessWidget {
  const MindSyncPage({Key? key}) : super(key: key);
        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Image.asset('assets/images/mind_sync.png', height: 150),
                const SizedBox(height: 20),
                const Text(
                  'Align Your Thoughts, Elevate Your Focus 🧠✨',
                      ...
                      _buildButton(
                        ...
                        () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => VoiceJournalPage()),
                          );
                        },
                      ),
                    ],
